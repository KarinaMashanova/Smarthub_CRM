...
function NavIcon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case 'schema': return <svg className={cls} viewBox="0 0 20 20" fill="none"><rect x="3" y="3" width="5" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/><rect x="12" y="3" width="5" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/><rect x="7.5" y="13" width="5" height="4" rx="1" stroke="currentColor" strokeWidth="1.5"/><path d="M8 5h4M5.5 7v2.5a1.5 1.5 0 001.5 1.5h3m4.5-4v2.5A1.5 1.5 0 0113 11h-3v2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>
    ...
    case 'profit': return <svg className={cls} viewBox="0 0 20 20" fill="none"><path d="M10 3v14M6 7l4-4 4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M4 17h12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/></svg>

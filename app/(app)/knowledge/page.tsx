...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Источник', desc: '«Вручную» — добавлено через UI. «Импорт» — загружено из старых данных. «AUTO» — создано синком заказов.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Еженедельно (авто)', desc: 'Понедельник 03:00 — магазины и список сотрудников из LiveSklad' },
      { label: 'Ручной запуск', desc: 'Раздел «Синхронизация» — ручной запуск текущей дельты заказов и продаж.' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'ЗП и бонусы', desc: 'Таблица TargetAction. Источники: MANUAL, IMPORT, AUTO. Авто-бонусы по заказам пересчитываются при обновлении заказа из LiveSklad.' },
    ],
  },
]
...
const ACCESS_ROWS = [
  ...
  ['Синхронизация', '—', 'Просмотр + ручной запуск дельты'],
        ...
        <div className="max-w-3xl space-y-3">
          ...
          <div className="bg-[#FFF9E0] border border-[#FFD600]/40 rounded-xl px-4 py-3">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Smarthub синхронизирует данные из <strong>LiveSklad</strong> каждые 15 минут.
              Смены, отпуска, ЗП и бонусы ведутся вручную администраторами.
              По расписанию обновляются заказы и продажи; авто-бонусы пересчитываются при обновлении заказов.
            </p>
          </div>
